...
public class headStandPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_stand_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(headStandPose.this, PhysicalActivity.class);
    ...
    private void openDialog() {
        headstandPoseDialog dialogReverse = new headstandPoseDialog();
