...
public class chaturangaPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chaturanga_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(chaturangaPose.this, PhysicalActivity.class);
    ...
    private void openDialog() {
        ChaturangaDialog dialogReverse = new ChaturangaDialog();
