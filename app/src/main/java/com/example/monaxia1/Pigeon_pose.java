...
public class Pigeon_pose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pigeon_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Pigeon_pose.this, PhysicalActivity.class);
    ...
    private void openDialog() {
       PigeonPoseDialog dialogReverse = new PigeonPoseDialog();
