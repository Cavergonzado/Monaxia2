...
public class LotusPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lotus_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(LotusPose.this, PhysicalActivity.class);
    ...
    private void openDialog() {
        LotusDialog dialogReverse = new LotusDialog();
