...
import com.example.monaxia1.BeginnerDialog.legsUpWallPoseDialog;
...
public class legsUpWallPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legs_up_wall_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(legsUpWallPose.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        legsUpWallPoseDialog dialogReverse = new legsUpWallPoseDialog();
