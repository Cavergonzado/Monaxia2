...
import com.example.monaxia1.BeginnerDialog.HeadToKneeForwardBendDialog;
...
public class HeadToKneeForwardBend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_to_knee_forward_bend);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(HeadToKneeForwardBend.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
       HeadToKneeForwardBendDialog dialogReverse = new HeadToKneeForwardBendDialog();
