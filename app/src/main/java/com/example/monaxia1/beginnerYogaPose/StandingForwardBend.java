...
import com.example.monaxia1.BeginnerDialog.StandingForwardBendPoseDialog;
...
public class StandingForwardBend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(StandingForwardBend.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        StandingForwardBendPoseDialog dialogReverse = new StandingForwardBendPoseDialog();
