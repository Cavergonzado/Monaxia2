...
import com.example.monaxia1.BeginnerDialog.SeatedForwardBendPoseDialog;
...
public class SeatedForwardBend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seated_forward_bend);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(SeatedForwardBend.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
       SeatedForwardBendPoseDialog dialogReverse = new SeatedForwardBendPoseDialog();
