...
import com.example.monaxia1.BeginnerDialog.treePoseDialog;
...
public class treePose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tree_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(treePose.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        treePoseDialog dialogReverse = new treePoseDialog();
