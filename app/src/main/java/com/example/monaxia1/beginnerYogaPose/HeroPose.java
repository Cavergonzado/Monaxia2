...
import com.example.monaxia1.BeginnerDialog.HeroPoseDialog;
...
public class HeroPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(HeroPose.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
       HeroPoseDialog dialogReverse = new HeroPoseDialog();
