...
import com.example.monaxia1.BeginnerDialog.ExtendedPuppyPoseDialog;
...
public class ExtendedPuppyPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extended_puppy_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(ExtendedPuppyPose.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        ExtendedPuppyPoseDialog dialogReverse = new ExtendedPuppyPoseDialog();
