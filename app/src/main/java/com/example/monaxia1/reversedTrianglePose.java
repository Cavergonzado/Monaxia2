...
public class reversedTrianglePose extends AppCompatActivity {
...
private  long mTimeLeftInMillis = START_TIME_IN_MILLIS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reverse_triangle_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(reversedTrianglePose.this, PhysicalActivity.class);
    ...
    private void openDialog() {
        reverseTraDialog dialogReverse = new reverseTraDialog();
