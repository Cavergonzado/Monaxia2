...
import com.example.monaxia1.advanceYogaDialog.PadmasanaDialog;
...
public class Padmasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Padmasana.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        PadmasanaDialog dialogReverse = new PadmasanaDialog();
