...
import com.example.monaxia1.advanceYogaDialog.SetuBandhasanaDialog;
...
public class Setu_Bandhasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Setu_Bandhasana.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        SetuBandhasanaDialog dialogReverse = new SetuBandhasanaDialog();
