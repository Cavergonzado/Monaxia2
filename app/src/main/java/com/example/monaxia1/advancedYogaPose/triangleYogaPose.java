...
import com.example.monaxia1.BeginnerDialog.trianglePoseDialog;
...
public class triangleYogaPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_triangle_yoga_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(triangleYogaPose.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        trianglePoseDialog dialogReverse = new trianglePoseDialog();
