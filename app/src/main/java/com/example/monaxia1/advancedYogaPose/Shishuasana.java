...
import com.example.monaxia1.advanceYogaDialog.ShishuasanaDialog;
import com.example.monaxia1.beginnerYogaPose.ChildPose;

import java.util.Locale;

public class Shishuasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shishuasana);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Shishuasana.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        ShishuasanaDialog dialogReverse = new ShishuasanaDialog();
