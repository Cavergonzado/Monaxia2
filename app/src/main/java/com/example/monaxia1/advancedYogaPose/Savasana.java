...
import com.example.monaxia1.advanceYogaDialog.ShavasanaDialog;
import com.example.monaxia1.beginnerYogaPose.ChildPose;

import java.util.Locale;

public class Savasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Savasana.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        ShavasanaDialog dialogReverse = new ShavasanaDialog();
