...
import com.example.monaxia1.advanceYogaDialog.HalasanaDialog;
import com.example.monaxia1.beginnerYogaPose.ChildPose;

import java.util.Locale;

public class Halasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Halasana.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        HalasanaDialog dialogReverse = new HalasanaDialog();
