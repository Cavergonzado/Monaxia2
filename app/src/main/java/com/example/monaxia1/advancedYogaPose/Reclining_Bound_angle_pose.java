package com.example.monaxia1.advancedYogaPose;
...
import com.example.monaxia1.BeginnerDialog.ChildPoseDialog;
import com.example.monaxia1.R;
import com.example.monaxia1.activities.BeginnerPhysicalActivity;
import com.example.monaxia1.advanceYogaDialog.RecliningBoundPoseDialog;
import com.example.monaxia1.beginnerYogaPose.ChildPose;

import java.util.Locale;

public class Reclining_Bound_angle_pose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reclining_bound_angle_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Reclining_Bound_angle_pose.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        RecliningBoundPoseDialog dialogReverse = new RecliningBoundPoseDialog();
