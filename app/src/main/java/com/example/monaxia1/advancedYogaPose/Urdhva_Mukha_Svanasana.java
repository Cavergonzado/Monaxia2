...
import com.example.monaxia1.advanceYogaDialog.UrdhvaMukhaDialog;
import com.example.monaxia1.beginnerYogaPose.ChildPose;

import java.util.Locale;

public class Urdhva_Mukha_Svanasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urdhva_mukha_svanasana);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Urdhva_Mukha_Svanasana.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
        UrdhvaMukhaDialog dialogReverse = new UrdhvaMukhaDialog();
