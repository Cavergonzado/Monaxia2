...
public class Adho_mukha_svanasana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adho_mukha_svanasana);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Adho_mukha_svanasana.this, BeginnerPhysicalActivity.class);
    ...
    private void openDialog() {
       AdhoMukhaSvanasanaDialog dialogReverse = new AdhoMukhaSvanasanaDialog();
