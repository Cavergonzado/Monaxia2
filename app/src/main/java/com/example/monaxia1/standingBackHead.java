...
public class standingBackHead extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.standing_backhead);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(standingBackHead.this, PhysicalActivity.class);
    ...
    private void openDialog() {
        StandingBackHeadDialog dialogReverse = new StandingBackHeadDialog();
