...
public class MetanoiaMusic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metanoia_music);
        start = findViewById(R.id.button);
        pause = findViewById(R.id.button2);
        seekBar = findViewById(R.id.seekBar);
        player = MediaPlayer.create(this, R.raw.metanoia);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(MetanoiaMusic.this, MusicFunction.class);
