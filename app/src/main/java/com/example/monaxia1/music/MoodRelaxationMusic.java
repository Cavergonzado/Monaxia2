...
public class MoodRelaxationMusic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player = MediaPlayer.create(this, R.raw.mood_relaxation);

        arrowback = findViewById(R.id.arrowBack);
        arrowback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(MoodRelaxationMusic.this, MusicFunction.class);
