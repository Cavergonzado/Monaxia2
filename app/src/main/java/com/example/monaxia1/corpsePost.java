...
public class corpsePost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corpse_post);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(corpsePost.this, PhysicalActivity.class);
    ...
    private void openDialog() {
       corpsePoseDialog dialogReverse = new corpsePoseDialog();
