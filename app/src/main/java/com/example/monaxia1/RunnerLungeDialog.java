...
public class RunnerLungeDialog extends AppCompatDialogFragment {
    @NonNull
    @Override
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setTitle("Runner's Lunge Pose")
                .setMessage("1.\tStart in Mountain pose and inhale into Upward Salute pose.\n" +
