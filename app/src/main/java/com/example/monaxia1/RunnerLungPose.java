...
public class RunnerLungPose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_runner_lung_pose);
        ...
        arrowback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(RunnerLungPose.this, PhysicalActivity.class);
    ...
    private void openDialog() {
        RunnerLungeDialog dialogReverse = new RunnerLungeDialog();
